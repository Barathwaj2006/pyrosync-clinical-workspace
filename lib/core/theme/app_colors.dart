...
enum AppThemeMode { clinicalDark, glassMode, clinicalLight }
...
class AppColors {
  ...
  // Waveform Viewport (STRICTLY NON-TRANSPARENT OBSIDIAN)
  ...
  // Status & Telemetry
  static const Color statusSuccess = Color(0xFF00E676); // < 5 kΩ
  static const Color statusWarning = Color(0xFFFFB300); // 5 - 10 kΩ
  static const Color statusDanger = Color(0xFFFF3D00);  // > 10 kΩ
